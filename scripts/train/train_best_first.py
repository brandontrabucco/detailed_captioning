...
def main(unused_argv):
    ...
    with tf.Graph().as_default():
        ...
        word_logits, wids, pointer_logits, pids = best_first_image_captioner(
            mean_image_features=image_features,
            word_ids=word_ids, pointer_ids=pointer_ids, lengths=tf.reduce_sum(indicator, [1]))
        ...
        with tf.Session() as sess:
            ...
            _target, _ids, _loss, _learning_step = sess.run([word_ids, wids, loss, learning_step])
