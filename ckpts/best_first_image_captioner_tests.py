...
def main(unused_argv):
    ...
    with tf.Graph().as_default():
        ...
        image_captioner = BestFirstImageCaptioner(
            UpDownCell(50), vocab, pretrained_matrix)
        word_logits, word_ids, pointer_logits, pointer_ids = image_captioner(
        ...
        with tf.Session() as sess:
            ...
            results = sess.run([word_logits, word_ids, pointer_logits, pointer_ids], 
